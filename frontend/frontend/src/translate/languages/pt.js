    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          useAIAgent: "Ativar Agente IA",
          aiAgentPrompt: "Prompt Base (O papel do robô)",
          aiAgentExtraCommands: "Instruções Extras / Regras",
          aiAgentTemperature: "Criatividade (Temperatura)",
      ...
      ticketOptionsMenu: {
        ...
        appointmentsModal: {
          ...
          textarea: "Anotação",
          placeholder: "Digite aqui sua anotação interna...",
        },
      },
      confirmationModal: {
        buttons: {
      ...
      queueIntegrationModal: {
        ...
        form: {
          ...
          urlN8N: "URL do n8n/Webhook",
          typebotSlug: "Slug do Typebot",
          typebotExpires: "Tempo de Expiração (minutos)",
          typebotKeywordCheck: "Palavra-chave para checagem",
          typebotKeywordFinish: "Palavra-chave para finalizar",
          typebotUnknownMessage: "Mensagem para desconhecido",
          typebotDelayMessage: "Delay entre mensagens (ms)",
          typebotKeywordRestart: "Palavra-chave para reiniciar",
          typebotRestartMessage: "Mensagem de reinicialização",
        },
        buttons: {
          test: "Testar",
          cancel: "Cancelar",
      ...
      aiInsights: {
        title: "Insights de IA e Qualidade",
        stats: {
          total: "Total de Análises",
          satisfaction: "Satisfação Média",
          perfect: "Conversas Nota 5"
        },
        categories: "Top Categorias de Dúvidas",
        suggestions: "Sugestões da IA para Gestão",
        recent: "Últimas Análises de Performance"
      },
    },
  },
};
